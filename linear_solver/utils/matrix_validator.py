        ...
        if analysis['is_square']:
            try:
                ...
                if analysis['is_symmetric']:
                    analysis['is_positive_definite'] = MatrixValidator.is_positive_definite(A)
                
                analysis['is_diagonally_dominant'] = MatrixValidator.is_diagonally_dominant(A, strict=False)
                analysis['is_strictly_diagonally_dominant'] = MatrixValidator.is_diagonally_dominant(A, strict=True)
