...
class TestCSVMatrixLoader:
    ...
    def test_save_augmented_matrix_with_header(self):
        ...
        try:
            ...
            A_loaded, b_loaded = CSVMatrixLoader.load_augmented_matrix(
                temp_path, skip_header=True
            )
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            for file_path in created_files:
                ...
                if (
                    ...
                    and "matriz_A" not in file_path.name
                    and "vetor_b" not in file_path.name
                ):
                    # Arquivo de matriz aumentada
                    A, b = CSVMatrixLoader.load_augmented_matrix(
                        file_path, skip_header=True
                    )
